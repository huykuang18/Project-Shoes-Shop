...
<body>
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
		...
		<section class="navbar-nav mr-auto">
			<a class="navbar-brand" href="admin"><i class="	fa fa-windows" aria-hidden="true"></i> Administrator</a>
		...
		<tbody>
			...
			<tr>
				<td style="width: 18%">
					...
					<a href="/admin/prices"><i class="fa fa-ticket" aria-hidden="true"></i></i>&nbsp;Quản lý đơn giá</a><hr>
					<a href="/admin/sales"><i class="fa fa-percent" aria-hidden="true"></i></i>&nbsp;Quản lý mức sale</a><hr>
