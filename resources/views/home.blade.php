...
<header>
		<script>
        var link_image = 'https://media0.giphy.com/media/bYWVnp0frBOta/giphy.gif ';
...
<section class="row">
	<img src="https://upload.wikimedia.org/wikipedia/commons/5/58/Skechers_Elite_Flex_shoe.gif" alt="">
...
<img src="{{asset('/images/sale.gif')}}" alt="" style="width: 70%;height: 150px;padding-top: 20px;">
<section class="row " style="padding-bottom: 20px">
	...
	<section class="product col-md-4 sp" >
		<section  id="images">
			...
			<section class="price" style="text-decoration: line-through;">
				9,000,000 <sup style="color: red;"><b>đ</b></sup>
			</section>
			<section class="price" style="color: red; padding-bottom: px">
				4,500,000 <sup style="color: red;"><b>đ</b></sup>
			</section>
			<section class="order">
